    ...
    <div className="bg-gradient-to-b my-2 from-white to-indigo-100 p-6 md:p-12 rounded-xl z-30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Boost Your Career</h2>
            <p className="text-gray-600 text-lg">
              There are over <span className="font-semibold">500</span> courses offered by the universities. Find exactly what you're looking for through our diverse catalog.
            </p>
          </div>
